	...
	initComponent: function(){
		 Ext.apply(this, {
			...
			columns: [
				...
				{header: 'Parent', dataIndex: 'parent', flex: 1, menuDisabled: true, sortable: true},
				{header: 'Child', dataIndex: 'child', flex: 1, menuDisabled: true, sortable: true},
			...
			listeners: {
				select: function(obj, rec, opts){
					...
					sto.getProxy().url = "/ajax/ags4/group/" + rec.get("group_code");
					sto.load()
				}
			}
		});
